const store_SQLReady = {
  'api-dev': {
    ...
    list: {
      ...
      meteor: {
        name: 'Meteor',
        keywords: ['meteor', 'meteorjs', 'meteor.js'],
        website: 'https://www.meteor.com',
      },
      nodejs: {
        name: 'Node.js',
        keywords: ['nodejs', 'node js', 'node.js'],
        website: 'https://nodejs.org',
      },
      rest: {
        name: 'REST',
        keywords: ['rest api', 'rest apis', 'restful'],
        website:
  ...
  cicd: {
    ...
    list: {
      ...
      teamcity: {
        name: 'TeamCity',
        keywords: ['teamcity', 'team city'],
        website: 'https://jetbrains.com/teamcity',
      },
      travisci: {
        name: 'Travis CI',
  ...
  'css-framework': {
    ...
    list: {
      ...
      materialize: {
        name: 'Materialize',
        keywords: ['materialize', 'materializecss'],
        website: 'https://materializecss.com',
      },
      materialui: {
        name: 'Material-UI',
        keywords: ['materialui', 'material ui', 'material-ui'],
        website: 'https://material-ui.com',
      },
      semanticui: {
        name: 'Semantic UI',
        keywords: ['semanticui', 'semantic ui'],
  ...
  'css-preprocessor': {
    ...
    list: {
      ...
      postcss: {
        name: 'PostCSS',
        keywords: ['postcss', 'post css'],
        website: 'https://postcss.org',
      },
      sass: {
        name: 'Sass / SCSS',
        keywords: ['sass', 'scss', 'sassy'],
  ...
  'database-relational': {
    ...
    list: {
      ...
      oracle: {
        name: 'Oracle',
        keywords: ['oracledb', 'oracle db'],
        website: 'https://www.oracle.com/database',
      },
      postgresql: {
        name: 'PostgreSQL',
        keywords: ['postgres', 'postgresql', 'postgre sql', 'postgre'],
  ...
  deployment: {
    ...
    list: {
      ...
      elasticbeanstalk: {
        ...
        keywords: ['elasticbeanstalk', 'elastic beanstalk'],
  ...
  'framework-js': {
    ...
    list: {
      ...
      aurelia: {
        name: 'Aurelia',
        keywords: ['aurelia', 'aureliajs', 'aurelia.js'],
        website: 'https://aurelia.io',
      },
      backbone: {
        name: 'Backbone.js',
        keywords: ['backbone', 'backbonejs', 'backbone.js'],
        website: 'https://backbonejs.org',
      },
      ember: {
        name: 'Ember.js',
        keywords: ['ember', 'emberjs', 'ember.js'],
        website: 'https://emberjs.com',
      },
      extjs: {
        name: 'Ext JS',
        keywords: ['extjs', 'ext js'],
      ...
      mithril: {
        name: 'Mithril',
        keywords: ['mithril', 'mithriljs', 'mithril.js'],
        website: 'https://mithril.js.org',
      },
      polymer: {
        name: 'Polymer',
        keywords: ['polymer', 'polymerjs', 'polymer.js'],
  ...
  'library-js': {
    ...
    list: {
      ...
      requirejs: {
        name: 'RequireJS',
        keywords: ['requirejs', 'require js', 'require.js'],
        website: 'https://requirejs.org',
      },
      threejs: {
        name: 'three.js',
        keywords: ['threejs', 'three js', 'three.js'],
        website: 'https://threejs.org',
      },
      underscore: {
        name: 'Underscore',
        keywords: ['underscore', 'underscore.js'],
  ...
  messagebroker: {
    ...
    list: {
      ...
      rabbitmq: {
        name: 'RabbitMQ',
        keywords: ['rabbitmq', 'rabbit mq'],
        website: 'https://www.rabbitmq.com',
      },
      wso2: {
        name: 'WSO2 Message Broker',
        keywords: ['wso2'],
        website: 'https://wso2.com/products/message-broker',
      },
    },
  },
  packagemanager: {
  ...
  ssg: {
    ...
    list: {
      ...
      next: {
        ...
        website: 'https://zeit.co/blog/next',
      },
      nuxt: {
        name: 'Nuxt.js',
        keywords: ['nuxtjs', 'nuxt js', 'nuxt.js'],
  ...
  statemanagement: {
    ...
    list: {
      flux: {
        name: 'Flux',
        keywords: ['flux'],
        website: 'http://facebook.github.io/flux',
      },
      mobx: {
        name: 'MobX',
        keywords: ['mobx'],
